...
const PATH_FONT_1 = `${process.env.ROOT_DIR || process.cwd()}/public/fonts/calibri.ttf`;
const PATH_FONT_2 = `${process.env.ROOT_DIR || process.cwd()}/public/fonts/calibrib.ttf`;
